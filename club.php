...
<section id="services">
    <div class="container">
        <div class="row">
            <div style="float:left;width:70%;background-color: #5bc0de;display: inline-block;">
                <div class="col-md-12">
            ...
            <div style="display: inline-block;float:right;width:230px;background-color: #de9c5f;">
