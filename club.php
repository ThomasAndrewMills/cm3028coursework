...
<section id="services">
    <div class="container">
        <div class="row">
            <div style="float:left;width:585px;background-color: #5bc0de;display: inline-block;">
                <div class="col-md-12">
            ...
            <div style="display: inline-block;width:585px;background-color: #de9c5f;padding-left:100px;">
