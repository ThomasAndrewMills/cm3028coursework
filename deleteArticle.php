                ...
                <div style="float:left;width:570px;">
                    <div class="section-title">
                        ...
                        <form action="healthNews.php" method="post">
                            ...
                            <input type="submit" name="deleteArticle" class="button" value="Yes, delete the article.">
                        </form>
                        <form action="healthNews.php">
                            <input type="submit" name="-" class="button" value="No, take me back to the previous page.">
                        </form>
