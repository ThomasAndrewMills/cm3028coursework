            ...
            <div class="col-md-9">
                ...
                while ($row = $result->fetch_array()) {
                    ...
                    '<div class="single-blog"style="display: block;">
						<article style="-webkit-box-shadow: 0px 0px 60px -10px rgba(0,0,0,0.8);
-moz-box-shadow: 0px 0px 60px -10px rgba(0,0,0,0.8);
box-shadow: 0px 0px 60px -10px rgba(0,0,0,0.8);">
